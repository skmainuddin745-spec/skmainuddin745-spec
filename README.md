...
[![YouTube](https://img.shields.io/badge/YouTube-Research%20Demos-FF0000?style=flat&logo=youtube&logoColor=white)](https://www.youtube.com/@stalwartsheikh1133)
...
I work at the intersection of **computational chemistry** and **AI engineering** — applying quantum mechanics/molecular mechanics (QM/MM), molecular dynamics simulations, and machine learning to accelerate drug discovery and understand biological mechanisms at the atomic level.

Currently developing automated pipelines for **transition-state location** in enzyme catalysis, building **hybrid quantum-classical neural networks** for medical imaging, and constructing **AI-driven industrial optimisation** systems that bridge simulation and real-world process control.
